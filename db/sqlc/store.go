...
type Store interface {
	Querier
	TransferTx(ctx context.Context, arg TransactionTxParam) (TransactionTxResult, error)
}
...
func (store *SQLStore) TransferTx(ctx context.Context, arg TransactionTxParam) (TransactionTxResult, error) {
