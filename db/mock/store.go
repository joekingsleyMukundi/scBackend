...
// Source: github.com/joekingsleyMukundi/bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) TransferTx(ctx context.Context, arg db.TransactionTxParam) (db.TransactionTxResult, error) {
	m.ctrl.T.Helper()
