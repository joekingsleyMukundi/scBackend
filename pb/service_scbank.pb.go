...
var File_service_scbank_proto protoreflect.FileDescriptor

var file_service_scbank_proto_rawDesc = string([]byte{
	0x0a, 0x14, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x73, 0x63, 0x62, 0x61, 0x6e, 0x6b,
	...
	0x67, 0x69, 0x6e, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc6,
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x6f, 0x65, 0x6b, 0x69, 0x6e, 0x67, 0x73, 0x6c, 0x65,
	0x79, 0x4d, 0x75, 0x6b, 0x75, 0x6e, 0x64, 0x69, 0x2f, 0x62, 0x61, 0x6e, 0x6b, 0x2f, 0x70, 0x62,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var file_service_scbank_proto_goTypes = []any{
...
var file_service_scbank_proto_depIdxs = []int32{
...
func init() { file_service_scbank_proto_init() }
func file_service_scbank_proto_init() {
	if File_service_scbank_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_service_scbank_proto_rawDesc), len(file_service_scbank_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_service_scbank_proto_goTypes,
		DependencyIndexes: file_service_scbank_proto_depIdxs,
	}.Build()
	File_service_scbank_proto = out.File
	file_service_scbank_proto_goTypes = nil
	file_service_scbank_proto_depIdxs = nil
}
